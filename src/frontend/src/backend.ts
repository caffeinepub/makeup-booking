...
import type { Booking as _Booking, BookingId as _BookingId, BookingStatus as _BookingStatus, MakeupService as _MakeupService, Slot as _Slot, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async bookAppointment(arg0: ServiceId, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Slot): Promise<BookingId> {
        if (this.processError) {
            try {
    ...
    async cancelMyBooking(arg0: BookingId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.cancelMyBooking(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createService(arg0: string, arg1: string, arg2: bigint, arg3: number): Promise<ServiceId> {
        if (this.processError) {
            try {
    ...
    async getAllServices(): Promise<Array<MakeupService>> {
        if (this.processError) {
            try {
    ...
    async getAvailableTimeSlots(arg0: ServiceId, arg1: string): Promise<Array<Slot>> {
        if (this.processError) {
            try {
    ...
    async getBookingsForDate(arg0: ServiceId, arg1: string): Promise<Array<Booking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingsForDate(arg0, arg1);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isTimeSlotAvailable(arg0: ServiceId, arg1: string, arg2: Slot): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isTimeSlotAvailable(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Booking]): Booking | null {
    return value.length === 0 ? null : from_candid_Booking_n4(_uploadFile, _downloadFile, value[0]);
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: _BookingId;
    service: _MakeupService;
    customerName: string;
...
function to_candid_BookingStatus_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BookingStatus): _BookingStatus {
    return to_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): _UserRole {
    return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BookingStatus): {
    cancelled: null;
} | {
    pending: null;
} | {
